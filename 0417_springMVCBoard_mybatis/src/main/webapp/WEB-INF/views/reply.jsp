...
<input type="hidden" name="seq" value="${vo.seq}"/>	<!-- 같을 글 그룹에서 글 출력 순서 -->
...
<!-- 답글을 입력하는 테이블 -->
<table width="500" align="center" border="1" cellpadding="5" cellspacing="0">
	<tr><th colspan="4">답글 쓰기</th></tr>
	<tr>
		<td align="center" width="80">이름</td>
		<td width="420"><input type="text" name="name"/></td>
	</tr>
	<tr>
		<td align="center">제목</td>
	...
	<tr>
		<td align="center">내용</td>
		<td><textarea rows="10" cols="45" name="content" style="resize: none;"></textarea></td>
	</tr>
	<tr>
